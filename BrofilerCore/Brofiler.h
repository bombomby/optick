...
#define BROFILER_TAG(NAME, ...)		static ::Brofiler::EventDescription* BRO_CONCAT(autogenerated_description_, __LINE__) = nullptr; \
									if (BRO_CONCAT(autogenerated_description_, __LINE__) == nullptr) BRO_CONCAT(autogenerated_description_, __LINE__) = ::Brofiler::EventDescription::Create( NAME, __FILE__, __LINE__ ); \
									::Brofiler::Tag::Attach(*BRO_CONCAT(autogenerated_description_, __LINE__), __VA_ARGS__); \
...
//			static Brofiler::EventStorage* IOStorage = Brofiler::RegisterStorage("GPU");
//
