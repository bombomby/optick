...
struct BROFILER_API GPUEvent
{
	...
	static EventData* Start(void* context, const EventDescription& description);
	static void Stop(void* context, EventData& data);

	GPUEvent(void* context, const EventDescription& description) : gpuContext(context)
	{
		data = Start(gpuContext, description);
	}

	~GPUEvent()
	{
		if (data && gpuContext)
			Stop(gpuContext, *data);
	}
};
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
BROFILER_API void InitGpuVulkan(void* device, void** cmdQueues, uint32_t numQueues);
...
#define BROFILER_GPU_INIT_VULKAN(DEVICE, CMD_QUEUES, NUM_CMD_QUEUS)			::Brofiler::InitGpuVulkan(DEVICE, CMD_QUEUES, NUM_CMD_QUEUS);

#define BROFILER_GPU_EVENT(CONTEXT, NAME)	 BROFILER_EVENT(NAME); \
											 ...
											 ::Brofiler::GPUEvent BRO_CONCAT(gpu_autogenerated_event_, __LINE__)( CONTEXT, *(BRO_CONCAT(gpu_autogenerated_description_, __LINE__)) ); \
