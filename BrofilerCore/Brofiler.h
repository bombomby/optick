...
#ifdef MT_GCC_COMPILER_FAMILY
#define __DECORATED_FUNCTION__ __PRETTY_FUNCTION__
#elif MT_MSVC_COMPILER_FAMILY
#define __DECORATED_FUNCTION__ __FUNCSIG__
#else
#error Need __DECORATED_FUNCTION__ definition
#endif
...
struct EventTime
{
	...
	BRO_INLINE void Start() { start  = MT::GetHighFrequencyTime(); }
	BRO_INLINE void Stop() 	{ finish = MT::GetHighFrequencyTime(); }
};
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
struct SyncData : public EventTime
{
	uint32 core;
...
#define PROFILE BROFILER_EVENT( __DECORATED_FUNCTION__ )
...
#define BROFILER_FRAME(FRAME_NAME) static bool currentFrameDescription = Brofiler::RegisterThread(FRAME_NAME);	\
									MT_UNUSED(currentFrameDescription);     \
									Brofiler::NextFrame();					\
									BROFILER_EVENT("Frame")					\

#define BROFILER_THREAD(FRAME_NAME) Brofiler::RegisterThread(FRAME_NAME);\
