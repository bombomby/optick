...
#define BROFILER_FRAME(FRAME_NAME) static Brofiler::ThreadDescription currentFrameDescription(FRAME_NAME);\
																																				Brofiler::NextFrame();						 \
																																				BROFILER_EVENT("Frame")							\

#define BROFILER_THREAD(FRAME_NAME) Brofiler::ThreadDescription currentFrameDescription(FRAME_NAME);\
