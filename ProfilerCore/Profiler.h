...
#if !defined(_FINALRELEASE) || defined(EMULATE_DEVELOPER_FINAL_RELEASE)
#define USE_PROFILER
#endif
...
struct PROFILER_API EventDescription
{
	...
	EventDescription();
	EventDescription( const char* eventName, const char* fileName, const unsigned long fileLine, const unsigned long eventColor = Color::Null );
private:
...
#pragma endregion
...
#ifdef USE_PROFILER
	#define PROFILER_EVENT(NAME) static Profiler::EventDescription BRO_CONCAT(autogenerated_description_, __LINE__)( NAME, __FILE__, __LINE__ ); \
	...
	#define PROFILER_CATEGORY(NAME, COLOR) static Profiler::EventDescription BRO_CONCAT(autogenerated_description_, __LINE__)( NAME, __FILE__, __LINE__, (unsigned long)COLOR ); \
																							  Profiler::Category				 BRO_CONCAT(autogenerated_event_, __LINE__)( (BRO_CONCAT(autogenerated_description_, __LINE__)) ); \

	#define PROFILER_FRAME Profiler::NextFrame();
#else
