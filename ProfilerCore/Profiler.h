...
{
	const char* name;
	FrameDescription(const char* threadName = "MainThread") : name(threadName) {}
};
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
#pragma endregion
	...
	#define PROFILER_FRAME(FRAME_NAME) static Profiler::FrameDescription currentFrameDescription(FRAME_NAME);\
																		  Profiler::NextFrame(currentFrameDescription);						 \
