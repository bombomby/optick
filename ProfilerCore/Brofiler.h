...
#if !defined(DISABLE_PROFILER) && !defined(USE_PROFILER) && (!defined(_FINALRELEASE) || defined(EMULATE_DEVELOPER_FINAL_RELEASE))

#if defined(LINUX64) || defined(ANDROID) || defined(WIN32) || defined(WIN64)
...
#define BROFILER_SHARED_EVENT(NAME, FRAME_PTR) 	static Profiler::EventDescription* BRO_CONCAT(autogenerated_description_, __LINE__) = Profiler::EventDescription::Create( NAME, __FILE__, __LINE__ );	\
												{																																						\
											   		FRAME_PTR = reinterpret_cast<void *>( new Profiler::Event( *(BRO_CONCAT(autogenerated_description_, __LINE__)) ) );																											\
											   	}																																						\
...
#define BROFILER_SHARED_FRAME(FRAME_NAME, FRAME_PTR) 	static Profiler::ThreadDescription currentFrameDescription(FRAME_NAME); \
								   						Profiler::NextFrame();													\
								   						BROFILER_SHARED_EVENT("Frame", FRAME_PTR)								\

#define BROFILER_SHARED_FRAME_FREE(FRAME_PTR) if ( nullptr != FRAME_PTR ) { delete reinterpret_cast<Profiler::Event *>(FRAME_PTR); }
...
#define BROFILER_SHARED_EVENT(NAME, FRAME_PTR)
#define PROFILE
#define BROFILER_INLINE_EVENT(NAME, CODE) { CODE; }
#define BROFILER_CATEGORY(NAME, COLOR)
#define BROFILER_FRAME(NAME)
#define BROFILER_SHARED_FRAME(NAME, FRAME_PTR) FRAME_PTR = reinterpret_cast<void*>( new int(0) );
// make assignment valid
#define BROFILER_SHARED_FRAME_FREE(FRAME_PTR)  if ( nullptr != FRAME_PTR ) { delete reinterpret_cast<int *>(FRAME_PTR); }
